...
<tr class="hide">
 ...
 $tableID.on('click', '.table-save', function () {
	...
	var timeinfo = '{"TotalNoBreakDec": "' + TotalNoBreakDec + '", "OvertimeDec": "' + OvertimeDec + '", "TotalDec": "' + TotalDec + '", "StartDec": "' + StartDec + '"}';
 ...
 $tableID.on('click', '.table-remove', function () {
	...
	if (confirm_response == true) {
		//$(this).parents('tr').detach();  // This is replaceed by setHistory()
