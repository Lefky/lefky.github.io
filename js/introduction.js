...
function playIntroduction() {
	...
	new_element.innerHTML =
		...
		'</div>' +
		'</div><br>' +
		'<i class="fas fa-arrow-down text-primary faa-pulse animated" style="font-size: 3rem; -webkit-text-stroke: 1px white; position: absolute; right: 135px; bottom: 50px;"></i>';
	document.getElementById("introductioncontainer").appendChild(new_element);
	...
	new_element.innerHTML =
		...
		'<button type="button" class="btn btn-sm btn-primary" onclick=' +
		'"this.parentElement.parentElement.parentElement.remove();' +
		'document.getElementById(\'arrow_footer_settings\').style.removeProperty(\'display\');">' + 	// 'document.getElementById(\'arrow_footer_info\').style.removeProperty(\'display\');">' +
		'<span aria-hidden="true">Next</span>' +
		'</button>' +
		'</div>' +
		'</div><br>' +
		'<i class="fas fa-arrow-down text-primary faa-pulse animated" style="font-size: 3rem; -webkit-text-stroke: 1px white; position: absolute; right: 80px; bottom: 50px;"></i>'; // right: 135px;
	document.getElementById("introductioncontainer").appendChild(new_element);
	...
	new_element.innerHTML =
		...
		'</div>' +
		'</div><br>' +
		'<i class="fas fa-arrow-down text-primary faa-pulse animated" style="font-size: 3rem; -webkit-text-stroke: 1px white; position: absolute; right: 80px; bottom: 50px;"></i>';
	document.getElementById("introductioncontainer").appendChild(new_element);
	*/
	...
	new_element.innerHTML =
		...
		'</div>' +
		'</div><br>' +
		'<i class="fas fa-arrow-down text-primary faa-pulse animated" style="font-size: 3rem; -webkit-text-stroke: 1px white; position: absolute; right: 25px; bottom: 50px;"></i>';
	document.getElementById("introductioncontainer").appendChild(new_element);
